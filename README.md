...
<p>
  ...
  <a href="CHANGELOG.md"><img src="https://img.shields.io/badge/changelog-0.33.0-64748b?style=flat-square" alt="Changelog"/></a>
...
All 36 methods share the same 3-line integration (`method="<id>"` in `KVCacheConfig`).
